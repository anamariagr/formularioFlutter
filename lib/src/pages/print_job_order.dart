...
class PrintJobOrder extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 25, 38, 83),
        title: Text('Orden de trabajo de impresion',
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    widgets
                        .dropdownText(items: ['Densidad', 'Item 2', 'Item 3']),
                    SizedBox(height: 8),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    widgets.inputTextGeneral(text: 'Cantidad solicitado'),
                    SizedBox(height: 8),
                    widgets.dropdownText(
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: 'Ingresa detalles de produccion...',
                        hintStyle: TextStyle(
                          fontSize: 14,
